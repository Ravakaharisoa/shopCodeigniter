			...
			<div class="span9">
				...
				<div class="row">	  
					<div id="gallery" class="span3">
	            		<a href="<?= base_url('assets/uploads/products/'.$product->product_image) ?>" title="<?= $product->product_name ?>">
							<img src="<?= base_url('assets/uploads/products/'.$product->product_image) ?>" style="width:100%" alt="<?= $product->product_name ?>"/>
	            		</a>
						<div id="differentview" class="moreOptopm carousel slide">
	                		<div class="carousel-inner">
	                  			<div class="item active">
		                   			<a href="<?= base_url('assets/uploads/products/'.$product->product_image) ?>"> 
		                   				<img style="width:29%" src="<?= base_url('assets/uploads/products/'.$product->product_image) ?>" alt=""/>
		                   			</a>
		                   			<a href="<?= base_url('assets/uploads/products/'.$product->product_image) ?>">
		                   			 	<img style="width:29%" src="<?= base_url('assets/uploads/products/'.$product->product_image) ?>" alt=""/>
		                   			</a>
					...
					<div class="span9">
            			...
            			<div id="myTabContent" class="tab-content">
              				<div class="tab-pane fade active in" id="home">
								...
								<h5>Features</h5>
								<p>14 Megapixels. 18.0 x Optical Zoom. 3.0-inch LCD Screen. Full HD photos and 1280 x 720p HD movie capture. ISO sensitivity ISO6400 at reduced resolution. Tracking Auto Focus. Motion Panorama Mode. Face Detection technology with Blink detection and Smile and shoot mode. 4 x AA batteries not included. WxDxH 110.2 ×81.4x73.4mm. Weight 0.341kg (excluding battery and memory card). Weight 0.437kg (including battery and memory card).<br/>OND363338</p>
